                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                        <div>
                            ...
                            <p className="text-lg text-white/80 max-w-lg">
                                Únete a los cientos de comercios que ya confían en Logify. Prueba gratis por 30 días, sin compromiso.
                            </p>
                        </div>
                        <div className="flex flex-col items-start lg:items-end gap-3 shrink-0">
                            <Link href="/registro" className="inline-flex items-center gap-2.5 bg-brand-1 text-brand-2 font-bold px-8 py-4 rounded-xl hover:bg-yellow-400 hover:-translate-y-1 transition-all shadow-lg shadow-brand-1/40">
