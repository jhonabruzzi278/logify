                ...
                <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-16 items-center">
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3 mb-10">
                            <a href="/registro" className="inline-flex items-center gap-2 bg-brand-1 text-ink font-bold px-7 py-4 rounded-xl hover:brightness-90 transition-all hover:-translate-y-0.5 shadow-[0_12px_30px_-8px_rgba(143,171,212,0.5)] focus:outline-none focus:ring-2 focus:ring-brand-3 focus:ring-offset-2 focus:ring-offset-canvas" aria-label="Prueba Logify gratis por 30 dias">
