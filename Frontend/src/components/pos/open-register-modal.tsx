      ...
      <div className="w-full max-w-sm rounded-lg bg-card p-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-[0.92px] text-muted-foreground">Monto inicial en caja</label>
            <Input type="number" min="0" value={openingAmount} onChange={(e) => setOpeningAmount(e.target.value)} placeholder="50000" className="h-9 text-sm" autoFocus />
          </div>
